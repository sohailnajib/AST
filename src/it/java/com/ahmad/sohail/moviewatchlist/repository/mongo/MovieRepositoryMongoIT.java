...
public class MovieRepositoryMongoIT {
    ...
    public void testFindAll() {
        movieCollection.insertOne(new Document()
            .append("id", "1").append("title", "Inception")
            .append("year", 2010).append("genreId", "1")
            .append("watched", false));
        movieCollection.insertOne(new Document()
            .append("id", "2").append("title", "Interstellar")
            .append("year", 2014).append("genreId", "1")
            .append("watched", false));
    ...
    public void testFindById() {
        ...
        assertThat(movieRepository.findById("2"))
            .isEqualTo(new Movie("2", "Interstellar", 2014, "1"));
    }

    @Test
    public void testSave() {
        movieRepository.save(new Movie("1", "Inception", 2010, "1"));
        assertThat(movieCollection.find().first().get("title"))
            .isEqualTo("Inception");
    }
