...
public class ModelViewControllerIT extends AssertJSwingJUnitTestCase {
	...
	public void testAddGenre() {
		...
		assertThat(genreRepository.findById("1")).isEqualTo(new Genre("1", "Action"));
	}
	...
	public void testDeleteGenre() {
		...
		await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(genreRepository.findById("1")).isNull());
	}
